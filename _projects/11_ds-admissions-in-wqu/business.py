...
class Experiment:
    def __init__(self, repo, db, collection):
        self.repo = repo
        self.db = db
    ...
    def run_experiment(self, days):
        # Dummy implementation: does nothing and returns a placeholder
        return {"status": "experiment run", "days": days}
...
class GraphBuilder:
    ...
    def build_age_hist(self):
        ...
        # Create Figure
        fig = px.histogram(x=ages,nbins=20,title="DS Applicants: Distripution of ages")
        # Set axis labels
        fig.update_layout(xaxis_title="Age" , yaxis_title='Freauency [count]')
    ...
    def build_ed_bar(self):
        ...
        fig.update_layout(xaxis_title="Frequancy [count]" , yaxis_title='Highes Degree Earned')
